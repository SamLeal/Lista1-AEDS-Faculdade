...
int ExB()
{
  ...
  printf("\n");
  return 0;
  // Quando se coloca 2, 2, 2 e 2 deve retornar a media sendo 2.
}
...
int ExC()
{
  ...
  printf("\n");
  return 0;
  // Quando coloca todas as notas como 2 e todos os pesos como 1 deve retornar uma media ponderada de 2.
}
...
int ExD()
{
  ...
  printf("\n");
  return 0;
  // Quando se coloca  5 celsius se espera 41 fahrenheit.
}
...
int ExE()
{
  ...
  printf("\n");
  return 0;
  // Quando o salario é 100 e o  percentual de aumento é 10 deve se retornar um novo salario de 110.
}
...
int ExF()
{
  ...
  printf("\n");
  return 0;
  // Quando a base é 2 e a altura é 1 deve se retornar a area de 1.
}
...
int ExG()
{
  ...
  printf("\n");
  return 0;
  // Quando o saco de ração pesa 20kg, e os gatos comem 100gramas por dia deve retornar 19.50 kg.
}
...
int ExH()
{
  ...
  printf("\n");
  return 0;
  // Quando se coloca 1 e 2 deve receber como resultado "O valor de A  é: 2. E o de B é: 1". 
}
...
int ExI()
{
  ...
  printf("\n");
  return 0;
  //Quando se digita o numero 10 deve retornar 3.
}
...
int ExJ()
{
  ...
  printf("\n");
  return 0;
  //Quando o primeiro termo for 1 o segundo termo for 2 e a quantidade de termos for 10, deve retornar a soma dos termos da PA como 55.
}
